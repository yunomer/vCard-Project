...
# A link for verifying that file download functionaity works
    <h3>Download test</h3>
    If testCardMin.vcf exists in the uploads/ directory on the server, then clicking on the link below will download it from the server.<br>
	<a href="/uploads/testCardMin.vcf">testCardMin.vcf</a>
	<hr>
