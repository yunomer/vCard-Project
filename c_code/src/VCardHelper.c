...
char* printBdayAnni(void* toBePrinted, char * name) {
    ...
    if(value == true) {
        char * result = malloc(sizeof(char) * (strlen(temp->text) + 15 + strlen(name)));
        strcpy(result, name);
    ...
    int finalLen = len1 + len2 + 10 + strlen(name);
...
VCardErrorCode propNameChecker (Property * ptr, Tags * tags) {
    ...
    // This would target tags: Kind BDAY IMPP LANG ROLE LOGO NOTE
        ...
        if ((name[0] == 'K') && (name[1] == 'I') && (name[1] == 'N') && (name[1] == 'D')) {  
        ...
        else if ((name[0] == 'B') && (name[1] == 'D') && (name[1] == 'A') && (name[1] == 'Y')) {  
            tags->bday = tags->bday + 1;
        }
        else if ((name[0] == 'I') && (name[1] == 'M') && (name[1] == 'P') && (name[1] == 'P')) {   
        ...
        else if ((name[0] == 'L') && (name[1] == 'A') && (name[1] == 'N') && (name[1] == 'G')) {   
        ...
        else if ((name[0] == 'R') && (name[1] == 'O') && (name[1] == 'L') && (name[1] == 'E')) {   
        ...
        else if ((name[0] == 'L') && (name[1] == 'O') && (name[1] == 'G') && (name[1] == 'O')) {   
        ...
        else if ((name[0] == 'N') && (name[1] == 'O') && (name[1] == 'T') && (name[1] == 'E')) {   
